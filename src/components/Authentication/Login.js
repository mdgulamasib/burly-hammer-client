    ...
    return (
        <div className='mx-auto'>
            ...
            <div className="md:w-1/4  mx-auto">
                <form onSubmit={handleSignIn} className="bg-primary-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <div className="mb-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <small className="inline-block align-baseline  text-sm text-blue-500 hover:text-blue-800 uppercase cursor-pointer pl-10" onClick={resetPassword}>Forgot Password ?</small>
                    </div>
